 ...
 */
 function signin(timeout = 3 * 1000) {
	return new Promise((resolve) => {
		let url = {
			url: `https://aweme.snssdk.com/luckycat/aweme/v1/task/done/treasure_task?_request_from=web&in_sp_time=0&version_code=14.9.0&js_sdk_version=1.95.0.29&tma_jssdk_version=1.95.0.29&app_name=douyin_lite&app_version=14.9.0&vid=8AEA1D03-B409-4C8B-AE14-FF0469B04256&device_id=427027580854696&channel=App%20Store&mcc_mnc=26011&aid=2329&screen_width=750&openudid=23a2171e78fd159c6e8e99f7e61cf5c65a0970ef&cdid=68979FFE-E0F9-4813-B0D4-1B4A490613BC&os_api=18&ac=4G&os_version=15.3.1&device_platform=iphone&build_number=149005`,    // 这是请求的 url 可以直接用我们抓包、精简后的URL
